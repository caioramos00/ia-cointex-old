...
function setupRoutes(
  ...
  app.post('/webhook/manychat', express.json(), async (req, res) => {
    ...
    if (JSON.stringify(payload).includes('{{') || JSON.stringify(payload).includes('}}')) {
    ...
    // ACK imediato (ManyChat tem timeout curto)
